...
axios.get(`${process.env.REACT_APP_ULR_API}/alluser/global`)
.then((response) => {
                     ...
                     <form  onSubmit={updateUserSubmitHandler}>
                            <div className="row mt-3">
                                <div className="col-md-12">
                                    ...
                                    >
                                    { Contest&&Contest.filter(i=>i.select_name).map(i=> (
                                    
                                    <option key={i.select_name} value={i.select_name}>{i.select_name}</option>
