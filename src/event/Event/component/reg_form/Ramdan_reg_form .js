...
export default function Non_lu_member() {
    ...
    return (
        <div style={{
            height: "auto", padding: "20px", background: 'snow', boxShadow: "4.0px 8.0px 8.0px hsl(0deg 0% 0% / 0.38)",
            backgroundImage: `url(${Bg})`, display: 'flex', justifyContent: 'left'
        }}>
                        ...
                        <div className="d-flex flex-column align-items-center text-center p-3 py-5">
                            ...
                            {user.reg_status == 'registerd' ? <button className="btn btn-success" type="button" style={{
                                ...
                                : user.reg_status == 'pending' ? <button className="btn btn-warning" style={{
                                    ...
                                    , boxShadow: 'rgba(0, 0, 0, 0.56) 0px 22px 70px 4px'
                                }} type="button">You are approved <br />for Program <br />plaease make sure <br />payment sucess</button>
