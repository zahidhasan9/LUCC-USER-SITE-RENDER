        ...
        backgroundImage: `url(${Bg})`
            ...
            <div className="container rounded bg-white mt-5 mb-5">
                <div className="row">
                    ...
                    // backgroundImage: "url(" + "https://cdn.pixabay.com/photo/2017/08/10/02/05/tiles-shapes-2617112_960_720.jpg" + ")",
                }}
                    >
                        ...
                        <div className="d-flex flex-column align-items-center text-center p-3 py-5">
                                ...
                                {user.reg_status=='registerd'?<button className="btn btn-success" type="button" style={{  width:'auto',height:"150px"
                                ,boxShadow: 'rgba(0, 0, 0, 0.56) 0px 22px 70px 4px'}}> Payment<br/> Sucessful <br/>You are Registered <br/></button>
                                : user.reg_status=='pending'?<button className="btn btn-warning" style={{  width:'150px',height:"150px"
                                ,boxShadow: 'rgba(0, 0, 0, 0.56) 0px 22px 70px 4px'}} type="button">You are approved <br/>for contestent <br/>plaease make sure <br/>payment sucess</button>
                                 :<button className="btn btn-danger" style={{  width:'150px',height:"150px"
                    ...
                    >
                        <div className="p-3 py-5">
                            <div className="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div className="mt-5 text-center">
                                    <div className="mt-5 text-center">
                                        <button onClick={print} className="btn btn-primary profile-button">Print Page</button>
                                    </div>
                                </div>
                                <hr></hr>
                     ...
                     <form  onSubmit={updateUserSubmitHandler}>
                            ...
                            <div className="col-md-12">
                                        ...
                                        >
                                            ...
                                            <option value="iftar_program">IFTAR PARTY </option>
                                            <option value="picnic_program">CSE PICNIC</option>
