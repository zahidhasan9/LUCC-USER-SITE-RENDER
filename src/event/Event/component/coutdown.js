...
function Countdown() {
    ...
    const History=useHistory();
     ...
     useEffect(() => {
      ...
      axios.get(`${process.env.REACT_APP_ULR_API}/global/61dc089f410a853a542123e8`)
  .then((response) => {
  ...
  const [ date, setDate] = useState("Jan 20, 2023");
...
//   compoundDidMount
  useEffect(() => {
    ...
    //   try {
    //     const {data: response} = await axios.get('http://localhost:2000/api/global/61dc089f410a853a542123e8');
    //     setuser(response);
    //   } catch (error) {
